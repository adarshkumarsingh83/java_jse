...
import com.adarsh.file.reader.FileInputStreamService;
import com.adarsh.file.reader.FileInputStreamServiceImpl;
import com.adarsh.file.writer.FileOutputStreamService;
import com.adarsh.file.writer.FileOutputStreamServiceImpl;
...
public class FileWriterAndReaderTest {
    ...
    private static FileOutputStreamService fileBufferedOutputStreamService;
    private static FileInputStreamService bufferedInputStreamService;


    static {
        fileBufferedOutputStreamService = new FileOutputStreamServiceImpl();
        bufferedInputStreamService = new FileInputStreamServiceImpl();
    }
