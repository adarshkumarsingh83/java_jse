...
/**
 *@Product: FileBufferedInputStreamService provides the specification for ..
 */
...
public class FileBufferedInputStreamServiceImpl implements FileBufferedInputStreamService {
    ...
    public List readData(File fileObject) throws Exception {
        ...
        do {
            charRead = bufferedInputStream.read(data);
            if (charRead != 0) {
